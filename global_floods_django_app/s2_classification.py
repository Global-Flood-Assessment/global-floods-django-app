...
def classification(footprint,cloud_coverage,start,end):
    BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    PATH = os.path.join(BASE_DIR, "global_floods_django_app", "mom_track3")
    ds = gdal.VectorTranslate(PATH+'/shapefile/Polygon.shp', footprint, format='ESRI Shapefile')
    ...
    products =api.query(footprint,date=(start,end), platformname='Sentinel-2', producttype = 'S2MSI2A', cloudcoverpercentage=cloud_coverage)
    product_name = []
    date = start
